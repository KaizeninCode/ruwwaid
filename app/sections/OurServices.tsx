    ...
    return (
        <section id='our-services' className='mx-auto px-4 lg:py-16 min-h-screen'>
          ...
          <div className="lg:grid lg:grid-cols-2 max-lg:flex max-lg:flex-col-reverse gap-16 lg:my-24">
            ...
            <div>
                    <img src="/services3.jpg" alt="Services" className='rounded-lg shadow-2xl'/>
                </div >
          </div>
          <div className="grid lg:grid-cols-2 gap-16 lg:my-24 my-8">
                <div>
                    <img src="/services2.jpg" alt="Services" className='rounded-lg shadow-2xl '/>
                </div >
                <div>
          ...
          <div className="lg:grid lg:grid-cols-2 max-lg:flex max-lg:flex-col-reverse gap-16 lg:my-24 my-8">
                ...
                <div>
                    <img src="/services1.jpg" alt="Services" className='rounded-lg shadow-2xl'/>
                </div >
          </div>
